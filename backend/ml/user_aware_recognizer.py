...
def audio_worker(voice_db):
    ...
    # Use the copied project-local ECAPA model path
    VOICE_MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Voice_recognition", "pretrained_ecapa_local")
